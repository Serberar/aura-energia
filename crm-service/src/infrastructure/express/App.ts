...
import { callsRouter, salesCallsRouter } from '@infrastructure/routes/callsRoutes';
import { smsRouter, salesSmsRouter } from '@infrastructure/routes/smsRoutes';
import internalRouter from '@infrastructure/routes/internalRoutes';
import skoreRouter from '@infrastructure/routes/skoreRoutes';
...
export class App {
  ...
  private configureRoutes(): void {
    ...
    this.app.use('/api/sales', salesCallsRouter);
    this.app.use('/api/sms', smsRouter);
    this.app.use('/api/sales', salesSmsRouter);
    this.app.use('/internal', internalRouter);
    this.app.use('/api/skore', skoreRouter);
