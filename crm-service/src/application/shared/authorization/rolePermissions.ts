export const rolePermissions = {
  ...
  sale: {
    ...
    GetComercialesUseCase: ['administrador', 'coordinador', 'verificador'],
    GetSaleByIdUseCase: ['administrador', 'coordinador', 'verificador'],
    ListSalesPaginatedUseCase: ['administrador', 'coordinador', 'verificador'],
